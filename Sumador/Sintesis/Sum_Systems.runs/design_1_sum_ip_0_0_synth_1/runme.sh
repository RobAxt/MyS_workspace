...
HD_PWD='C:/Xilinx/MyS_workspace/Sumador/Sintesis/Sum_Systems.runs/design_1_sum_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sum_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sum_ip_0_0.tcl
