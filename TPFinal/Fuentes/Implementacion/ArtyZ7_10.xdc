...
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { serial_out_pin }]; #IO_L17P_T2_34 Sch=JA1_P
...
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { serial_input_pin }]; #IO_L22P_T3_34 Sch=JA4_P
