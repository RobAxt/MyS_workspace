...
HD_PWD='C:/Xilinx/MyS_workspace/TPFinal/Sintesis/Transceiver/Transceiver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log transceiver_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source transceiver_wrapper.tcl -notrace
