...
HD_PWD='C:/Xilinx/MyS_workspace/TPFinal/Sintesis/Transceiver/Transceiver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transceiver_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transceiver_wrapper.tcl
