...
HD_PWD='C:/Xilinx/MyS_workspace/TPFinal/Sintesis/Transceiver/Transceiver.runs/transceiver_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transceiver_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transceiver_processing_system7_0_0.tcl
