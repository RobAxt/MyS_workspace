...
HD_PWD='C:/Xilinx/MyS_workspace/TPFinal/Sintesis/Transceiver/Transceiver.runs/transceiver_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transceiver_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transceiver_rst_ps7_0_100M_0.tcl
