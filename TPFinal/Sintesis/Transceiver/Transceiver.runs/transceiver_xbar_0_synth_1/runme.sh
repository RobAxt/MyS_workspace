...
HD_PWD='C:/Xilinx/MyS_workspace/TPFinal/Sintesis/Transceiver/Transceiver.runs/transceiver_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transceiver_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transceiver_xbar_0.tcl
